...
$DaysNo = 0;  
	...
	$sql = "SELECT  A.Lead_Id, A.Sales_Executive_Id, A.Division, A.Company , A.Country , A.Project , A.Project_Value , A.Project_Status, A.Remarks, A.Percentage, A.Expected_Completion_Month, A.No_Competitors, A.Quarter, A.Last_FollowUp_Date,A.Comments,B.Sales_Executive_Id,B.Sales_Executive_Name from intermetal.project_details A JOIN intermetal.sales_executive_details B  on A.Sales_Executive_Id = B.Sales_Executive_Id ORDER BY Lead_Id ASC;";//"SELECT * FROM employee_master";
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage" style ="cursor: default;">Intermetal</a>
    </div>
...
<div class="card">
  ...
  <h4 style=" font-family: Montserrat, sans-serif;cursor: default;"><?php if (isset($_SESSION['user'])) { echo $_SESSION['user'];} ?></h4>
  <p style=" font-family: Montserrat, sans-serif;cursor: default;" class="title">Sales Executive</p>
  <p style=" font-family: Montserrat, sans-serif;cursor: default;">Intermetal</p>
   <br>
  <br>
...
<br>
			...
			<h3 style=" font-family: Montserrat, sans-serif;"><center>DATA GRID</center></h3>	
			  <!-- <th style="text-align : left;font-size: 14px; background-color : #000000" ></th> -->
			    <th style="text-align : left;font-size: 14px; background-color : #000000; color :white; font-family: Montserrat, sans-serif;cursor: default;">Lead ID</th>
			   <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;">Sales Executive Name</th>
               <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;">Division</th> 
			   <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;">Company</th>
			   <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;">Country</th> 
			   <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;">Project</th> 
			   <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;">Project Value </th>
			    <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;">Project Status <br> <br> <center><i class="fa fa-edit" style="font-size28px;color:white"></i></center></th>
			    <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;"> Percentage <br> <br><br> <center><i class="fa fa-edit" style="font-size28px;color:white"></i></center></th>
				 <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;">Expected Completion Month <br> <center><i class="fa fa-edit" style="font-size28px;color:white"></i></center></th>
				  <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;">Last Follow Up Date <br>  <center><i class="fa fa-edit" style="font-size28px;color:white"></i></center></th>
				   <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;">Competitor <br> <br> <br> <center><i class="fa fa-edit" style="font-size28px;color:white"></i></center></th>
				   <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;">Comments <br> <br> <br><center><i class="fa fa-edit" style="font-size28px;color:white"></i></center></th>
			  <th style="text-align : left;font-size: 14px; background-color : #000000 ; color :white; font-family: Montserrat, sans-serif;cursor: default;"> Update</th>
			   </tr>
			  </thead>
			 <tbody>
            ...
            <form method = "post" autocomplete="off" action="<?php echo $_SERVER["PHP_SELF"];?>">
				...
				<td style="text-align : left;font-size: 14px;  font-weight: 400;" ><input style="width:100px; font-family: Montserrat, sans-serif;" name="id" id="id" value=<?php echo "'".$row['Lead_Id']."'" ?> readonly /></td>

                 <td style="text-align : left;font-size: 14px;  font-weight: 400;" ><input style="width:100px; font-family: Montserrat, sans-serif;" name="Code" id="Code" value=<?php echo "'".$row['Sales_Executive_Name']."'" ?> readonly /></td>
 ...
 function isNumberKey(txt, evt) {
	...
	<div id="project" class="container-fluid text-center">
	 ...
	 <div class="table-responsive">
         ...
         <table  width="70%" class="test inner" style="margin: 0 auto; background-color:#fff; text-align:left; filter: alpha(opacity=40); opacity: 0.95;" >
		  <thead class="table table-bordered" style="background-color:#000000;text-align:center; width:100% ">
		  <th style="text-align:left; font-size: 18px; font-family: Montserrat, sans-serif; color :#fff  !important;" colspan="6"><center>NEW PROJECT DETAILS
		  <span style="text-align : left;font-size: 14px;" class="error">&nbsp; * All fields are mandatory</span>
		  </center></th></thead>
            <tbody>
		 <br/>
			<tr>
...
<tr>
 <td class = "pd" style="text-align : left;font-size: 14px; font-weight: 400"><b>Expected Month</b></th>  
  <td style="text-align : left;font-size: 14px;"><input class="sd" style = "border-radius: 5px; font-weight: 400; "  type="text"  id="pick_date" name="expectedmonth" placeholder="Expected Month .." required>
</td>
...
var dates = $("#pick_date").datepicker({
    ...
    onSelect: function(selectedDate) {
        var option = this.id == "pick_date" ? "minDate" : "maxDate",
...
$(document).on("change", ".sd", function() {
    ...
    $(".total").val(sum);
			...
			<tr align="left">
			<td class = "pd" style="text-align : left;font-size: 14px; font-weight: 400"></th> 
                <td style="text-align : left;font-size: 14px;">
                <input type = "submit" class="btn btn-primary " style="width:110px;height:40px; font-size: 14px;"  name = "submit" value = "Save" onclick="">
               
                <button type="cancel" class="btn btn-primary " style="width:110px;height:40px; font-size: 14px;" onclick="http://localhost/Intermetal/new.php">Cancel</button>
            </td>
            </tr>
			</tbody>
         </table>
...
$competitor=$_POST["competitor"];
	...
	//echo $Employeecode." ".$followup."  ".$status." ".$expectedmonth;
    $sql = "SELECT Sales_Executive_Id FROM intermetal.project_details where Lead_Id ='".$leadid."'";
  //echo $sql;
   $result = $conn ->query($sql);
        if (!empty($result) && $result->num_rows > 0) {
			//echo "------------------------------------------>>>>>>>>>>>>>>>>>>>>>>>>>> ";
            $sql1 = "UPDATE intermetal.project_details SET Project_Status = '".$status."', Percentage = '".$percentage."', Expected_Completion_Month = '".$expectedmonth."', Last_FollowUp_Date = '".$followup."', No_Competitors = '".$competitor."', Comments = '".$comm."' where Lead_Id ='".$leadid."'";
//echo "sql1       : ".$sql1;           
